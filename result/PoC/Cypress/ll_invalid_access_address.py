...
# pkt.show2()
# change the access address to 0x12345678
ble_sul.packet_construction.smp_handle.access_address = 0x12345678

ble_sul.packet_send_received_control(send_pkt=pkt,connect_min_attempts = 10,connect_max_attempts = 150)
ble_sul.packet_construction.smp_handle.access_address = ble_sul.access_address
