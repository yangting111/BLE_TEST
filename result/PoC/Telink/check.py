...
from Ble_state_check.srcs.Config_File.Telink import config
...
###
"ll_version_ind_pkt,pairing_request_pkt,pairing_confirm_pkt,pairing_random_pkt,ll_enc_req_pkt,ll_start_enc_rsp_pkt,ll_enc_rsp_pkt,ll_pause_enc_rsp_pkt,pairing_random_pkt"
...
# pkt["SM_Pairing_Request"].authentication = 0x13
...
pkt.show2()
ble_sul.packet_send_received_control(send_pkt=pkt,connect_min_attempts = 10,connect_max_attempts = 50)
# pkt = ble_sul.get_packet("att_read_req_pkt")
# pkt.show2()
# ble_sul.packet_send_received_control(send_pkt=pkt,connect_min_attempts = 10,connect_max_attempts = 50)
...
# pkt.show2()
# ble_sul.packet_send_received_control(send_pkt=pkt,connect_min_attempts = 10,connect_max_attempts = 50)
# pkt = ble_sul.get_packet("ll_pause_enc_rsp_pkt")
# pkt.show2()
# ble_sul.packet_send_received_control(send_pkt=pkt,connect_min_attempts = 10,connect_max_attempts = 50)
# pkt = ble_sul.get_packet("pairing_random_pkt")
# pkt.show2()
