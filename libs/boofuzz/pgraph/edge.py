...
class Edge:
    ...
    def __init__(self, src, dst):
        ...
        self.id = (src.number << 32) + dst.number
        self.src = src
        self.dst = dst
    ...
    def render_edge_gml(self, graph):
        ...
        src = graph.find_node("label", self.src.label)
        dst = graph.find_node("label", self.dst.label)
    ...
    def render_edge_graphviz(self):
        ...
        dot_edge = pydot.Edge(self.src.render_node_graphviz(), self.dst.render_node_graphviz())
