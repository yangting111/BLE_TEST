...
device = {
    ...
    "statepkt_dict": {"ll_base":['ll_feature_req_pkt', 'll_version_ind_pkt','ll_length_req_pkt', "ll_length_rsp_pkt"],"sm_legency":['pairing_request_pkt','pairing_confirm_pkt', 'pairing_random_pkt', ],"sm_sc":['pairing_request_pkt','pairing_public_key_pkt',"pairing_random_pkt","pairing_dhkey_check_pkt"]},
}

fuzz = {
    "fuzz_pcap_filename": "/home/yangting/Documents/Ble_Test/result/log_file/Esp32/test_l2cap_fuzz.pcap",
