...
from Ble_state_check.srcs.Config_File.WCH import config
...
elements_to_remove = ['ll_connection_update_ind_pkt', 'll_channel_map_req_pkt', 'll_terminate_ind_pkt','ll_connection_param_req_pkt','pairing_public_key_pkt']
...
w_method_eq_oracle = WMethodEqOracle(alphabet= alphabet, sul = ble_sul, max_number_of_states = 9, shuffle_test_set = True, tested_letters_file = tested_letters_file, out_put_path = out_put_path,callback=None)
