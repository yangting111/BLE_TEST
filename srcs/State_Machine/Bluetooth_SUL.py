...
from BLESFuzz.libs.scapy.contrib import send
from Ble_Mesh_Test.libs.ble_decrypter.utils import key
...
from Ble_Mesh_Test.driver.NRF52_dongle import NRF52Dongle
import Ble_Mesh_Test.srcs.Send_Packet.constant as constant
from Ble_Mesh_Test.srcs.Send_Packet.Packet_Constuction import Packet_Constuction
from Ble_Mesh_Test.srcs.Packet_Process.Pcap_Packet_Process import Packet_Process
from Ble_Mesh_Test.srcs.Fail_Exception.Fail_Exception import *
import configparser
from Ble_Mesh_Test.srcs.Packet_Process.Out_map import get_map
...
class Bluetooth_SUL(SUL):
    ...
    def packet_send_received_control(self, send_pkt, connect_min_attempts=constant.NORMAL_MIN_ATTEMPTS, connect_max_attempts=constant.NORMAL_MAX_ATTEMPTS, repeat=None, log = False): 
        ...
        if isinstance(send_pkt,list):
            ...
            if send_pkt.haslayer('SM_Public_Key'):
                connect_min_attempts = 110
                connect_max_attempts = 110
    ...
    def post(self):
        ...
        for i in range(3):
            ...
            self.packet_send_received_control(terminate_pkt, connect_min_attempts=3, connect_max_attempts=3)
        #     # terminate_pkt = self.packet_construction.get_pkt('ll_feature_req_pkt')  
